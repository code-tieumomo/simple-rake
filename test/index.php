...
$text = 'Điểm nghẽn trong cỗ máy kinh tế Nga
Rắc rối của kinh tế Nga đang bị che lấp bởi "thất nghiệp ẩn" - nhân công không bị sa thải, nhưng phải tạm nghỉ việc vô thời hạn.

Tỷ lệ thất nghiệp ở Nga hiện ở mức thấp kỷ lục, cho thấy quá trình tách rời khỏi phương Tây suôn sẻ một cách đáng ngạc nhiên. Việc McDonald’s và Starbucks bị thay thế nhanh chóng cũng chứng tỏ hoạt động kinh doanh vẫn ổn định. Tuy nhiên, sức ép bên trong cỗ máy kinh tế này đang ngày một tăng.
...
$simpleRake = new \Quanph\SimpleRake\SimpleRake($text);
$simpleRake->setLocale('vi');

$keywords = $simpleRake->extractKeywords();
echo '<pre>';
print_r($keywords);
echo '</pre>';
die;